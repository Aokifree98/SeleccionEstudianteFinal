...
class AsignaturaTestCase ( unittest.TestCase ) :
    ...
    def test_verificar_almacenamiento_agregar_asignatura(self):
        ...
        self.gestionAsignatura.agregar_asignatura(nombreAsignatura="Pruebas de software")
    ...
    def test_editar_asignatura ( self ) :
        resultado = self.gestionAsignatura.editar_asignatura ( idAsignatura = 1 , nombreAsignatura = "Estructura de datos" )
        self.assertEqual ( resultado , True)